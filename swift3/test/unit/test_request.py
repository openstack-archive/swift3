...
from swift3.response import InvalidArgument, NoSuchBucket, NoSuchKey, \
    InternalError
...
class TestRequest(Swift3TestCase):
    ...
    def test_get_bucket_info(self):
        ...
        with patch('swift3.request.get_container_info',
            ...
            info = s3_req.get_bucket_info(MagicMock())
        ...
        for status, expected_error in expected_errors:
            with patch('swift3.request.get_container_info',
                ...
                self.assertRaises(
                    expected_error, s3_req.get_bucket_info, MagicMock())
