    ...
    def test_canonical_string_v4(self):
        ...
        env = {
            'HTTP_AUTHORIZATION': (
                ...
                'SignedHeaders=date;host, Signature=X'),
            'HTTP_HOST': 'host.foo.com'}
        # TODO: this is weird because the test suite doesn't suggest bucket
        # in the host name but utf8 format is not supported in bucket name.
        # Plus, the hash 306539... never appearerd in the s4test suite.
        # I am wondering how does he get the hash string?
