...
class S3TokenMiddlewareTestBad(S3TokenMiddlewareTestBase):
    ...
    def test_fail_to_connect_to_keystone(self):
        with mock.patch.object(self.middleware, '_json_request') as o:
            s3_invalid_resp = self.middleware._deny_request('InvalidURI')
            o.side_effect = s3_token.ServiceError(s3_invalid_resp)
    ...
    def test_bad_reply_missing_token_dict(self):
        self._test_bad_reply_missing_parts(self, 'access', 'token')

    def test_bad_reply_missing_user_dict(self):
        self._test_bad_reply_missing_parts(self, 'access', 'user')

    def test_bad_reply_missing_user_roles(self):
        self._test_bad_reply_missing_parts(self, 'access', 'user', 'roles')

    def test_bad_reply_missing_user_name(self):
        self._test_bad_reply_missing_parts(self, 'access', 'user', 'name')

    def test_bad_reply_missing_user_id(self):
        self._test_bad_reply_missing_parts(self, 'access', 'user', 'id')

    def test_bad_reply_missing_tenant_dict(self):
        self._test_bad_reply_missing_parts(self, 'access', 'token', 'tenant')

    def test_bad_reply_missing_tenant_id(self):
        self._test_bad_reply_missing_parts(self, 'access', 'token', 'tenant', 'id')

    def test_bad_reply_missing_tenant_name(self):
        self._test_bad_reply_missing_parts(self, 'access', 'token', 'tenant', 'name')
