...
class TestSwift3MultiUpload(Swift3FunctionalTestCase):
    ...
    def test_object_multi_upload(self):
        ...
        exp_size = MIN_SEGMENT_SIZE * len(etags)
        ...
        # TODO: this requires https://review.openstack.org/#/c/556683/ to work
        # check_obj({'If-Match': exp_etag}, 200)
        # In light of above -- SLO responds 200 but we translate to 412
        check_obj({'If-Match': swift_etag}, 412)
        # In light of above -- I'm not sure why this passes
