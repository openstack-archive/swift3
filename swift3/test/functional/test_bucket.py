...
class TestSwift3Bucket(unittest.TestCase):
    ...
    def test_put_bucket_error(self):
        ...
        status, headers, body = self.invalid_conn.make_request('PUT', 'bucket')
    ...
    def test_get_bucket_error(self):
        ...
        status, headers, body = self.invalid_conn.make_request('GET', 'bucket')
        self.assertEquals(get_error_code(body), 'SignatureDoesNotMatch')
    ...
    def test_head_bucket_error(self):
        ...
        status, headers, body = \
            self.invalid_conn.make_request('HEAD', 'bucket')
    ...
    def test_delete_bucket_error(self):
        ...
        status, headers, body = \
            self.invalid_conn.make_request('DELETE', 'bucket')
        self.assertEquals(get_error_code(body), 'SignatureDoesNotMatch')
