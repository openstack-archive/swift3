...
class Connection(object):
    ...
    Manage Connection
    """
    def __init__(self, aws_access_key=None, aws_secret_key=None, user_id=None):
...
def get_connection(aws_access_key=os.environ.get('ADMIN_ACCESS_KEY'),
...
def get_tester1_connection():
    """
    Return tester1 connection
    """
