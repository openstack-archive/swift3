...
class Request(swob.Request):
    ...
    def _parse_query_authentication(self):
        ...
        if 'AWSAccessKeyId' in self.params:
            # AWSAccessKeyId is supported in v2
            try:
        ...
        elif 'X-Amz-Credential' in self.params:
            # AWSAccessKeyId is supported in v4
    ...
    def _parse_auth_info(self):
        ...
        """
        if any(param in self.params for param in
               ['AWSAccessKeyId', 'X-Amz-Credential']):
