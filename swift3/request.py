...
class S3AclRequest(Request):
    ...
    def get_response_acl(self, app, method=None, container=None, obj=None,
                         headers=None, body=None, query=None):
    ...
    def get_response(self, app, method=None, container=None, obj=None,
        ...
        acl_handler = get_acl_handler(self.controller_name)(self, app)
        resp = acl_handler.handle_acl()
        ...
        return self.get_response_acl(app, method, container, obj,
                                     headers, body, query)
