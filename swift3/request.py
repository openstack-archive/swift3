...
class Request(swob.Request):
    ...
    def __init__(self, env, slo_enabled=True):
        ...
        self.access_key, signature, is_v4_request = self._parse_authorization()
        ...
        # format.
        self.headers['Authorization'] = 'AWS %s:%s' % (self.access_key,
                                                       signature)
    ...
    def _parse_authorization(self):
        ...
        return access, signature, is_v4_request
