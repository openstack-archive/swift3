...
class Request(swob.Request):
    ...
    def xml(self, max_length, check_md5=False, missing_body_error=None):
        """
        ...
        if missing_body_error is not None and not body:
            # pylint doesn't recognize the type check above, and thinks we may
            # raise None. So...
            # pylint: disable=raising-bad-type
            raise missing_body_error
