...
class SigV4Mixin(object):
    ...
    def _headers_to_sign(self):
        ...
        if 'host' in headers_lower_dict:
            # NOTE: Some clients may contains port number into
            # host header (really?) but S3 calculates just only
            # host name instead of host:port so we remove the port
            # info here
