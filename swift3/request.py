...
class Request(swob.Request):
    ...
    def _headers_to_sign(self):
        ...
        in the StringToSign.
        """
        # NOTE(andrey-mp): Only original request headers can be used
        # for signature calculation. So we skip headers that have added by
        # previous pipeline modules
        added_headers = ['accept-encoding', 'authorization', 'etag',
