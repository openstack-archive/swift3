...
from swift3.response import Response
from swift3 import utils as swift3_utils
...
class S3Token(object):
    ...
    def __init__(self, app, conf):
        ...
        # SSL
        insecure = swift3_utils.bool_from_string(conf.get('insecure', False))
    ...
    def __call__(self, environ, start_response):
        ...
        if isinstance(tenant_to_connect, types.UnicodeType):
