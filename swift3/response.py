...
class Response(ResponseBase, swob.Response):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.bucket_acl = decode_acl('container', sysmeta_headers)
        self.object_acl = decode_acl('object', sysmeta_headers)
