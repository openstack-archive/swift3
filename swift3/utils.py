...
def sysmeta_prefix(resource):
    ...
    """
    if resource == 'object':
        # TODO: Return object-sysmeta-swift3 after Swift supports updating of
        # system metadata for objects.
        # See, the following URLs of gerrit.
        #     https://review.openstack.org/#/c/79991/4
        #     https://review.openstack.org/#/c/109609/
